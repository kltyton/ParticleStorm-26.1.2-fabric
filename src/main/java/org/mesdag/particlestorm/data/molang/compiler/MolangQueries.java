...
public final class MolangQueries {
    ...
    private static void setDefaultQueryValues() {
        ...
        registerQueryVariable("query.moon_brightness", p -> 0.0);
        ...
        registerQueryVariable("query.total_particle_count", p -> Minecraft.getInstance().particleEngine.trackedParticleCounts.values().stream().mapToInt(Integer::intValue).sum());
